        ...
        for frame in response_frames:
            ...
            for offset, value in enumerate(frame.values):
                ...
                register_rows[address] = {
                    ...
                    # Every register from a capture starts as a plain 16-bit
                    # reading; a user who knows two adjacent addresses here
                    # are actually one wider value can combine them via the
                    # Profile tab's own Format column after saving.
                    "data_type": "uint16",
